...
geotab.addin.output = function() {
    ...
    var optionsButton = document.getElementById("optionsButton"),
        ...
        sortbyArrowSVG = document.getElementById("sortbyArrowSVG"),
        sortbyArrowPath = document.getElementById("sortbyArrowPath"),
    ...
    sortbyArrowSVG.addEventListener("click", function(e) {
        console.log("stop");
        e.stopPropagation();
    });
    sortbyArrowPath.addEventListener("click", function(e) {
        console.log("stop");
        e.stopPropagation();
    });
    ...
    periodPicker_today.addEventListener("click", function() {
        document.getElementById("custom-date").setAttribute("class", "customDateOFF");
    ...
    periodPicker_custom.addEventListener("click", function() {
        document.getElementById("custom-date").setAttribute("class", "customDateON");
    });
    ...
    function generateTableContentRow(CurrentActiveIndex, bool) {
        ...
        if (bool) {
            labelON.setAttribute("class", "onOFFButton geotabButton");
        } else {
            labelON.setAttribute("class", "onOFFButton geotabButton disabled");
        }
        ...
        if (bool) {
            labelOFF.setAttribute("class", "onOFFButton geotabButton");
        } else {
            labelOFF.setAttribute("class", "onOFFButton geotabButton disabled");
        }
